    ...
    <Router>
      <div className="min-h-screen bg-dark-900 text-gray-200 flex flex-col">
        ...
        <Routes>
          ...
          <Route path="/code-analyzer" element={<><Header /><motion.main className="flex-1 container mx-auto px-4 py-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.2 }}><CodeAnalyzer /></motion.main></>} />
          <Route path="/debugger" element={<><Header /><motion.main className="flex-1 container mx-auto px-4 py-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.2 }}><Debugger /></motion.main></>} />
